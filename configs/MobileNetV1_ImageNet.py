...
config = {'network': 'MobileNetV1', 'dataset': 'ImageNet', 'modes': {}}


# -----------------------------------------------
# Baseline
# -----------------------------------------------
baseline_mode = {'type': 'baseline'}
...
baseline_mode['optim_opt'] = optim_opt

scheduler_opt = {}
scheduler_opt['epochs'] = 100
scheduler_opt['type'] = 'EpochBasedExponentialLR'
scheduler_opt['decay'] = 0.96
baseline_mode['scheduler_opt'] = scheduler_opt

other_opt = {}
other_opt['image_size'] = 224
other_opt['batch_size'] = 128
other_opt['num_workers'] = 24
baseline_mode['other_opt'] = other_opt

config['modes']['baseline'] = baseline_mode
...
other_opt['pretrained'] = 'CHECKPOINTS/MobileNetV1_ImageNet/baseline/baseline.pth'
